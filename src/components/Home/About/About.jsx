...
const About = () => {
  return (
    <div id='about' class="my-3 py-20 px-5 md:mx-10">
      <div className="">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <div>
            <img className="rounded w-full h-[400px] pl-0 " src={aboutImg} alt="" />
          </div>
          <div>
            <hr className="w-1/6 border-4 border-yellow-300 my-3"/>
            <h2 className="text-4xl font-semibold">About Us</h2>
            <p className="text-lg my-5">
            <span className="italic font-bold">KU Entertainment  </span>  is a leading web design and marketing agency. We
