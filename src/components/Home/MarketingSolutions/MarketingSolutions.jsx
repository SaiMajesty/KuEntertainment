...
Email list building, We will help you develop a targeted email list of potential customers and fans.
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                  <button className="bg-secondary h-1/3 rounded text-xl text-white">
                    Learn More
                  </button>
                  <img className="" src={box1} alt="" />
                </div>
              </div>
              <div className="bg-secondary p-10 rounded-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                  <button className="bg-white h-1/3 rounded text-xl">
                    Learn More
                  </button>
                  <img className="" src={box2} alt="" />
                </div>
              </div>
            </div>
            <div className="bg-secondary p-10 rounded-lg mt-10">
              <h4 className="text-2xl my-5 text-primary font-semibold">
                Content Stratergy
              </h4>
              <p className="my-5 text-white">
              ...
              <div className="flex gap-10 items-center justify-between">
                <button className="bg-white h-1/3 rounded text-xl py-3 px-5">
                  Learn More
                </button>
                <img className="w-1/6" src={box3} alt="" />
              </div>
            </div>
          </div>
